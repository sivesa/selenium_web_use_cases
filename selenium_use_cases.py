...
class LoginPage:
    def __init__(self, driver):
        ...
        self.sign_in_button = (By.NAME, 'sign_in')  # Adjust selector as needed
...
class TestLogin:
    def __init__(self):
        self.driver = webdriver.Chrome()  # Ensure chromedriver is in your PATH or provide the path to it
...
if __name__ == "__main__":
    test = TestLogin()
    test.perform_login('sivesandla@gmail.com', 'Dada@123')
    test.close_browser()
